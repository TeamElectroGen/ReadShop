...
const PagesHeader = ({ title, subtitle, path, path2 }) => {
  console.log(path);
  return (
    <header className="relative mt-12 w-full overflow-hidden rounded-2xl bg-gradient-to-tr from-primary to-primary/80">
      <div className="container px-4 py-16 sm:px-6 lg:px-8">
        <div className="relative z-10 text-center">
          ...
          <p className="mt-4 text-xl leading-7 text-white/90">{subtitle}</p>
