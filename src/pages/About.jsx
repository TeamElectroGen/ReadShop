...
<section className="overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white dark:bg-dark">
  ...
  <div className="mt-10 lg:mt-0">
    ...
    <p className="mb-5 text-base text-body-color dark:text-dark-6">
      Immerse yourself in captivating stories, explore diverse genres, and
      find books that ignite your passion. Our curated collection offers
      something for every reader.
    </p>
    <p className="mb-8 text-base text-body-color dark:text-dark-6">
      From classic literature to modern bestsellers, we have a wide range of
      books to suit your taste. Whether you're a seasoned reader or just
...
<section className="bg-white py-12">
  <div className="container mx-auto text-center">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
      {/* Mentor 1 */}
      <div className="bg-[#4B5563] shadow-lg rounded-2xl p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
        <Image
        ...
        <a
          href="#"
          className="text-blue-400 mt-4 inline-block text-sm font-medium hover:text-blue-500 hover:underline"
        >
          Read more &rarr;
        </a>
      </div>
      ...
      {/* Mentor 2 */}
      <div className="bg-[#4B5563] shadow-lg rounded-2xl p-6 mt-8 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
        <Image
      ...
      {/* Mentor 3 */}
      <div className="bg-[#4B5563] rounded-2xl shadow-lg  p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
        <Image
      ...
      {/* Mentor 4 */}
      <div className="bg-[#4B5563] shadow-lg rounded-2xl p-6 mt-12 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
        <Image
        ...
        <p className="text-sm text-gray-400">Digital Marketing Director</p>
        <a
          href="#"
          className="text-blue-400 mt-4 inline-block text-sm font-medium hover:text-blue-500 hover:underline"
        >
