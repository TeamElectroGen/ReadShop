...
const Card = ({ book }) => {
  ...
  return (
    <Link
      ...
      className="z-20 mb-4 flex h-full w-full flex-col space-y-3 overflow-hidden rounded-xl border-2 border-white/70 bg-background/50 p-4 backdrop-blur-md transition-all duration-300 ease-in hover:shadow-md md:max-w-[212px]"
    >
      {/* Book Cover Image */}
